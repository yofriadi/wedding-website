# database-baseline Specification

## Purpose

Create the current invitation, RSVP, and guest-photo schema reproducibly on an empty target while protecting existing environments from implicit reset.
